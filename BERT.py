...
train_df = load_split(r"filepath")
test = load_split(r"filepath")


train, val = train_test_split(train_df, test_size=0.2, random_state=42, stratify=train_df_reddit['stance'])
